...
to sample
  ...
  set turtles-in-circle moving-turtles with [distance circle-center <= circle-radius]
  ...
  ; Report the heights
  ask turtles-in-circle [
  output-print (word precision height 3)
...
"" ""
PENS
"default" 0.2 1 -16777216 true "" "histogram heights-in-a-sample"
